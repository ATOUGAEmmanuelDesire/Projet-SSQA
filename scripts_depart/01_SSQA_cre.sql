...
Version : 0.2.1a (d’après AirEstrie de Christina Khnaisser)
Statut : en vigueur
...
create table Capacite (
  ...
  constraint Capacité_cr0 foreign key (station) references Station (code),
  constraint Capacité_cr1 foreign key (variable) references Variable (code)
  );
